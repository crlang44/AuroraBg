...
(function () {
  ...
  const FRAG_SCENE = `
      ...
      void main(){
        ...
        if (dy > 0.002) {
          ...
          vec3 web = max(vec3(cr, cg, cb) - 0.17, 0.0) * 6.0 * vec3(0.50, 0.90, 1.15);
  ...
  const FRAG_FALLBACK = `
      ...
      void main(){
        ...
        vec3 colBottom = vec3(0.08, 0.35, 0.70);
        vec3 colMid    = vec3(0.10, 0.45, 0.80);
        vec3 colTop    = vec3(0.10, 0.62, 0.85);
        ...
        col += pGlow * 0.5 * vec3(0.3, 0.45, 0.9);
